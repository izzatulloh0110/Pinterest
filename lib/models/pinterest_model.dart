import 'dart:convert';
PinterestModel PinterestModelFromJson(String str) => PinterestModel.fromJson(json.decode(str));

String PinterestModelToJson(PinterestModel data) => json.encode(data.toJson());
...
class PinterestModel {
  ...
  factory PinterestModel.fromJson(Map<String, dynamic> json) => PinterestModel(
    id: json["id"],
    ...
    links: json["links"] == null ? null : PinterestModelLinks.fromJson(json["links"]),
...
class PinterestModelLinks {
  ...
  factory PinterestModelLinks.fromJson(Map<String, dynamic> json) => PinterestModelLinks(
    self: json["self"],
    html: json["html"],
