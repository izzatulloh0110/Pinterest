...
class Network {
  ...
  /* Http parsing */
  static List<PinterestModel> parseResponse(String response) {
    List json = jsonDecode(response);
    List<PinterestModel> photos = List<PinterestModel>.from(json.map((x) => PinterestModel.fromJson(x)));
    return photos;
  }
  ...
  static List<PinterestModel> parseSearchParse(String response) {
    Map<String, dynamic> json = jsonDecode(response);
    List<PinterestModel> photos = List<PinterestModel>.from(json["results"].map((x) => PinterestModel.fromJson(x)));
    return photos;
  }
}
